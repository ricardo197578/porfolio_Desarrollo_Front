...
- Tarjetas de proyectos con links.
- Seccion de peliculas favoritas.
- Formulario basico de contacto.
...
- `[X]` Se ha defi nido un título descriptivo.
...
- `Respuesta:` Efecto hover en tarjetas y botones
